...
namespace Food_Ordering_System
{
    public partial class SignupForm : Form
    {
        ...
        private void txt_password_TextChanged(object sender, EventArgs e)
        {
            ...
            // Optionally, you can change the color of the label based on strength
            if (strength == "Very Strong")
            {
                errorpassword.ForeColor = Color.LightGreen; // Bright green for high contrast
            }
            else if (strength == "Strong")
            {
                errorpassword.ForeColor = Color.LightBlue; // Bright cyan for good contrast
            }
            else if (strength == "Medium")
            {
                errorpassword.ForeColor = Color.LightYellow; // Bright yellow for visibility
            }
            else
            {
                errorpassword.ForeColor = Color.White; // White for weak passwords
            }
